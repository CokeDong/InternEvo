...
TRAIN_FOLDER = "/share/muxi_data/temp/temp_data_20240906/"  # "/path/to/dataset"
VALID_FOLDER = None  # "/path/to/dataset"
data = dict(
    type="streaming",
    tokenizer_path="/share/work/huangting/tokenizer",
    seq_len=SEQ_LEN,
...
parallel = dict(
    ...
    weight=dict(size=16, overlap=True, memory_pool=False),
    sequence_2D=dict(
        enable=True,
        head_size=8,
        context_size=8,
